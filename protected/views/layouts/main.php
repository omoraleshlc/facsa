...
<div class="container" id="page">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" >
      <div class="navbar-inner" >
        <div class="container" >
          ...
          <img height="20" src="./images/i_um.jpeg" width="20"></img>
          UNIVERSIDAD DE MONTEMORELOS   -Facultad de Ciencias de la Salud-
          </a>
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> Universidad de Montemorelos, Facultad de Ciencias de la Salud.<br/>
