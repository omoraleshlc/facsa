...
var XPhoto = XPhotoClass({
    ...
    createButtons: function(){
    	var buttons = '';
    	if(this.options.capture===true){
    		buttons += '<button type="button" class="btn btn-success xphoto-button-camera"><i class="fa fa-camera"></i>Grabar</button>'
					  +'<button type="button" class="btn btn-primary xphoto-button-snap" style="display:none;"><i class="fa fa-circle"></i></button>';
		}
		if(this.options.upload===true){
			buttons += '<button type="button" class="btn btn-default xphoto-button-upload"><i class="fa fa-upload"></i>Cargar Imagen</button>';
		}
